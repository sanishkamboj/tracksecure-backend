...
module.exports = async (to, planData) => {
  try {
                                  ...
                                  >
                                    <tr>
                                      ...
                                      >
                                        Hello!<br />
                                        <br />
                                        Your tracksecure plan has been renewed.
                                        <br />
                                    ...
                                    <tr>
                                      <td colspan="2">
                                        <p>
                                          <strong
                                            >Here is you subscription plan
                                            details:</strong
                                          >
                                        </p>
                                        <table width="100%" class="plan-tbl">
                                          <tr>
                                            <td style="width: 20%;">
                                              <b>Plan: </b>
                                            </td>
                                            <td>${planData.vPlanName}</td>
                                          </tr>
                                          <tr>
                                            <td style="width: 20%;">
                                              <b>User Limit: </b>
                                            </td>
                                            <td>${planData.iUserLimit}</td>
                                          </tr>
                                          <tr>
                                            <td style="width: 20%;">
                                              <b>Assessment Limit: </b>
                                            </td>
                                            <td>${planData.iAssessmentLimit}</td>
                                          </tr>
                                          <tr>
                                            <td style="width: 20%;">
                                              <b>Plan usage start date: </b>
                                            </td>
                                            <td>${planData.dStartDate}</td>
                                          </tr>
                                          <tr>
                                            <td style="width: 20%;">
                                              <b>Plan usage end date: </b>
                                            </td>
                                            <td>${planData.vPlanName}</td>
                                          </tr>
                                          <tr>
...
`
    ...
    if (sentMail) {
      console.log('Plan renewal mail sent!')
    }
  } catch (error) {
